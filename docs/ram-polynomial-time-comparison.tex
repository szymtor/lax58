...
\author{}
\date{Lax759944 and the current Lax560851 example --- 6 September 2026}

\begin{document}
\begin{center}
  {\Large\bfseries Two notions of polynomial time on the word-RAM}\par
  {\small Lax759944 and the current Lax560851 example\enspace\textbullet\enspace 6 September 2026}
\end{center}

The definitions differ in both their input-size measure and their required
word-width threshold. This note compares Lax759944's \code{RamPolytime} with
\code{PolynomialTime} in Lax560851's \code{RamComplexityExample}, not with the
...
keeping arena input. For natural-number outputs, its equivalence with Lax759944 is
...
\small
\textit{Status.} Both the separation and the general equivalence with Lax759944
are kernel-checked. See \code{Lax759944.RamPolytime} and
\code{Lax560851.RamPolynomialComparison} for the source definitions.
\end{document}
