...
output codecs have computable encoders and parsers. On canonical inputs the
operation produces the canonical encoding of the function value; behavior on
malformed strings is immaterial.
-/
