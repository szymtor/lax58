...
open Lax58 Lax58.StructuralPresentation Lax58.StructuralCombinators
open Lax58.RamComplexity Lax58.CertifiedDerivation
...
instance : Lax58.StructuralDerivation.FieldEncoding Bool where
  toRaw _ := Raw.nat 999
...
example (f T W : Nat → Nat) :
    (RamComputableWithin f T W) ↔
      ∃ p : Lax13.Ram.Program, ∀ n w : Nat,
        n < 2 ^ w → 3 ≤ 2 ^ w → W n ≤ 2 ^ w →
        Lax13.RamComputes.ComputesInTime w p
          {(Lax58.WordArena.encodeRaw (.nat n)).toInput}
...
open Lax58.RamComplexityExample in
...
/-- info: 'Lax58.RamComplexityExample.PolynomialTime' depends on axioms: [propext] -/
#guard_msgs in
#print axioms Lax58.RamComplexityExample.PolynomialTime

/-- info: 'Lax58.RamComplexityExample.LinearInFirstInput' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms Lax58.RamComplexityExample.LinearInFirstInput
