...
open Lax560851.CertifiedDerivation
...
example : Lax560851.StructuralDerivation.fieldRaw (7 : Nat) = Raw.nat 42 := rfl
example : Lax560851.StructuralDerivation.fieldRaw (Leaf.value 7) = Raw.nat 43 := rfl
...
instance : Lax560851.StructuralDerivation.FieldEncoding (Nat → Nat) where
  toRaw _ := Raw.nat 42
...
/--
error: Invalid `⟨...⟩` notation: Constructor for `Lax560851.CertifiedDerivation.CertifiedFieldEncoding` is marked as private
-/
#guard_msgs in
