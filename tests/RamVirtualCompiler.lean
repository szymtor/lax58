...
open Lax13.Ram Lax58Proofs.RamVirtualCompiler
open Lax58.StructuralCombinators Lax58.WordArena
...
private def checkArenaToNative (label : String) (v : Nat) (p : Program)
  ...
  let compiled := outputAfterHalt (v + 1)
    (Lax58Proofs.RamArenaToNativeCompiler.compile p) 5000 (initState arena)
  unless source == some expected do
    throw (IO.userError s!"{label}: incorrect source test fixture: {source}")
  unless compiled == source do
...
private def checkNativeToArena (label : String) (v : Nat) (p : Program)
  ...
  let compiled := outputAfterHalt (v + 1)
    (Lax58Proofs.RamNativeToArenaCompiler.compile p) 10000 (initState native)
  unless source == some expected do
    throw (IO.userError s!"{label}: incorrect source test fixture: {source}")
  unless compiled == source do
...
/-- info: 'Lax58Proofs.RamVirtualCompiler.mask_result' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs in
#print axioms Lax58Proofs.RamVirtualCompiler.mask_result
/-- info: 'Lax58Proofs.RamVirtualCompiler.compile_get' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms Lax58Proofs.RamVirtualCompiler.compile_get

#print axioms Lax58Proofs.RamVirtualMacros.readCell_execute
#print axioms Lax58Proofs.RamVirtualMacros.writeCell_execute
#print axioms Lax58Proofs.RamVirtualMacros.compile_start
#print axioms Lax58Proofs.RamVirtualMacros.run_eq_execute
#print axioms Lax58Proofs.RamVirtualSimulation.runsTo_compile
